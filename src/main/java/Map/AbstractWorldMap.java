...
import mapmanagement.MapObjectsHandler;
...
abstract public class AbstractWorldMap {
    ...
    public static void calculateJungleSize() {
        jungleSize = new Vector2d((int) (width * 0.99), (int) (height * jungleRatio));
    ...
    public abstract Vector2d positionAfterMove(Vector2d oldPosition, Vector2d moveVector, Animal animal);
